...
import { addproduct, categoryList, deleteCoupon, deleteProduct, deleteService, editproduct, getCoupons, getProducts, getServices, productStatusUpdate, serviceStatusUpdate } from "../../apis/SuperAdmin";
...
export const Coupons = () => {
    ...
    const columns = useMemo(
        () => [
            ...
            { header: "Discount", accessorKey: "discount_value" },
    ...
    return (
        <>
            <div className="p-6  main main_page min-h-screen duration-800 ease-in-out">
                <BreadcrumbsNav customTrail={[{ label: "Coupons", path: "/coupons" }]} />
                ...
                {/* <UserTable /> */}
                <div className="mt-4">
                    <ProductTable columns={columns} productList={couponList} isLoading={isLoading} />
