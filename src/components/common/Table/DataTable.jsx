...
export const DataTable = ({ adminListData, isLoading, handleEdit, handleDelete }) => {
  console.log("adminListData in table:", adminListData);
      ...
      },
      {
        ...
        cell: (info) => (
          <div className="w-10 h-10 rounded-full overflow-hidden bg-gray-200">
            <img src={`${IMG_BASE_URL}${info.getValue()}`} alt="profile" width={40} style={{ borderRadius: "50%" }} className="w-full h-full object-cover" />
          </div>
        ),
      },
